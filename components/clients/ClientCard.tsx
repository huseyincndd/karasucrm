      ...
      <div className="relative flex items-start gap-4 mb-5">
        <div className="relative flex-shrink-0">
          {client.logo ? (
            ...
            <div className={`w-14 h-14 rounded-xl flex items-center justify-center text-white font-black text-xl shadow-sm bg-gradient-to-br ${client.package === 'premium' ? 'from-purple-500 to-indigo-600' :
                client.package === 'gold' ? 'from-blue-500 to-cyan-600' :
          ...
          <div className="flex flex-wrap gap-1.5 items-center">
            <span className={`
               ...
               ${client.package === 'premium' ? 'bg-purple-50 text-purple-600 border border-purple-100' :
                client.package === 'gold' ? 'bg-blue-50 text-blue-600 border border-blue-100' :
